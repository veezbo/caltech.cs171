...
public class HW7 {
	...
	//Parse in Data
		final String FILE = "sample.script";	
    ...
    //Setting up OpenGL
    	...
    	CallbackListener callbackHandler = new CallbackListener(xRes, yRes, r);
    ...
    //TODO: We want an animator for this homework. Set that up.
